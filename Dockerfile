...
ARG SHIM_ARCHIVE_URL=https://github.com/rhboot/shim/releases/download/16.1/shim-16.1.tar.bz2
ARG SHIM_ARCHIVE_FILE=shim-16.1.tar.bz2
ARG SHIM_ARCHIVE_SHA256=46319cd228d8f2c06c744241c0f342412329a7c630436fce7f82cf6936b1d603
...
FROM scratch
COPY --from=builder /work/output/x86_64/boot/efi/EFI/ZeronsoftN/shimx64.efi /
COPY --from=builder /work/output/aarch64/boot/efi/EFI/ZeronsoftN/shimaa64.efi /
COPY --from=builder /work/output/ia32/boot/efi/EFI/ZeronsoftN/shimia32.efi /
